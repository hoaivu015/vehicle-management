...
| **`@rbac`** | **RBAC & Access Governance** | [rbac-access-governance](file:///.agents/skills/rbac-access-governance/SKILL.md) | Bảo mật Phân quyền Đa tầng (3-Tier RBAC/ABAC), Quản trị `PermissionService`, `PermissionsPage`, Route & Tab Guarding trong `MainContent.tsx`, Chuẩn hóa Skeleton Loading State (CLS = 0). |
